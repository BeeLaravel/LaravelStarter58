    ...
    <div class="container">
        ...
        <table class="list">
            <tr v-for="(item, index) in list">
                <td>{{item.title}}</td>
                <td class="opreate">
                    <a :href="control.download_api_url_base + item.id">下载</a>
        ...
        <div class="create" v-show="control.show_create">
            ...
            <div class="content">
                ...
                <div class="input">
                    <textarea id="" cols="30" rows="10" v-model="item.content" placeholder="内容"></textarea>
                </div>
                <div class="input">
    ...
    export default {
        data() {
            return {
                ...
                item: {},
                control: {
                    api_url_base: '/api/custom_fonts',
                    font_api_url_base: '/api/fonts',
                    download_api_url_base: '/api/download/custom_fonts/',
                    show_create: false,
                    is_edit: false,
                    filter: "",
                    default_font_id: 0,
