...
// ## 函数
// getRegionDatasetResponse getRegionDataset(getRegionDataset $parameters)
// getRegionProvinceResponse getRegionProvince(getRegionProvince $parameters)
// getRegionCountryResponse getRegionCountry(getRegionCountry $parameters)
// getSupportCityDatasetResponse getSupportCityDataset(getSupportCityDataset $parameters)
// getSupportCityStringResponse getSupportCityString(getSupportCityString $parameters)
