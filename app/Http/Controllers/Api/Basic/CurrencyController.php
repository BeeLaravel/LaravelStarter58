...
use App\Http\Requests\Basic\CurrencyRequest as ThisRequest;
use App\Models\Basic\Currency as ThisModel;
use App\Transformers\Basic\CurrencyTransformer as ThisTransformer;

class CurrencyController extends Controller { // 包管理
