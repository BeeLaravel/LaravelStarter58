...
use App\Http\Requests\Warehouse\WarehouseRequest as ThisRequest;
use App\Models\Warehouse\Warehouse as ThisModel;
use App\Transformers\Warehouse\WarehouseTransformer as ThisTransformer;

class WarehouseController extends Controller { // 包管理
