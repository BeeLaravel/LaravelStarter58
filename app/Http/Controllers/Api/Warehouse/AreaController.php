...
use App\Http\Requests\Warehouse\AreaRequest as ThisRequest;
use App\Models\Warehouse\Area as ThisModel;
use App\Transformers\Warehouse\AreaTransformer as ThisTransformer;

use Storage;

class AreaController extends Controller { // 包管理
