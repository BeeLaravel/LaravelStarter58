...
use App\Http\Requests\Warehouse\ExceptionRequest as ThisRequest;
use App\Models\Warehouse\Exception as ThisModel;
use App\Transformers\Warehouse\ExceptionTransformer as ThisTransformer;

class ExceptionController extends Controller { // 消费
