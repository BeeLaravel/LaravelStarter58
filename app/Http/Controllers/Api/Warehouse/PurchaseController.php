...
use App\Http\Requests\Warehouse\PurchaseRequest as ThisRequest;
use App\Models\Warehouse\Purchase as ThisModel;
use App\Transformers\Warehouse\PurchaseTransformer as ThisTransformer;

class PurchaseController extends Controller { // 采购单
