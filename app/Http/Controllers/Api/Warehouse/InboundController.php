...
use App\Http\Requests\Warehouse\InboundRequest as ThisRequest;
use App\Models\Warehouse\Inbound as ThisModel;
use App\Transformers\Warehouse\InboundTransformer as ThisTransformer;

class InboundController extends Controller { // 消费
