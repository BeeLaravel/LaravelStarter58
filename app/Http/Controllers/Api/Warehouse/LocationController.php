...
use App\Http\Requests\Warehouse\LocationRequest as ThisRequest;
use App\Models\Warehouse\Location as ThisModel;
use App\Transformers\Warehouse\LocationTransformer as ThisTransformer;

class LocationController extends Controller { // 包管理
