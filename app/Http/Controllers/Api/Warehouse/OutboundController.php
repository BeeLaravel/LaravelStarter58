...
use App\Http\Requests\Warehouse\OutboundRequest as ThisRequest;
use App\Models\Warehouse\Outbound as ThisModel;
use App\Transformers\Warehouse\OutboundTransformer as ThisTransformer;

class OutboundController extends Controller { // 消费
