...
use App\Http\Requests\Tool\AccountRequest as ThisRequest;
use App\Models\Tool\Account as ThisModel;
use App\Transformers\Tool\AccountTransformer as ThisTransformer;

class AccountController extends Controller { // 包管理
